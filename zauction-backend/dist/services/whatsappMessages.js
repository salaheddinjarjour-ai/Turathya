...
exports.WHATSAPP_MESSAGES = void 0;
exports.getWishlistMessageByIndex = getWishlistMessageByIndex;
...
function getWishlistMessageByIndex(index) {
    const messages = exports.WHATSAPP_MESSAGES.wishlistUpdates;
    if (!messages.length) {
        return '';
    }
