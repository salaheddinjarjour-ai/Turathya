...
export function toImageRef(stored: string | null | undefined, url: string): string | null {
 ...
 */
export function sendStoredImage(res: Response, stored: string | null | undefined, fallback = '/assets/images/og-default.png') {
    if (!stored) {
